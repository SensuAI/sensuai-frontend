    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <svg width="100%" height="200%" viewBox="0 0 2560 1920" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.6 }}>
          ...
          <defs>
            ...
            >
              ...
              <feGaussianBlur stdDeviation="82" result="effect1_foregroundBlur_37_453"></feGaussianBlur>
            </filter>
            <radialGradient
      ...
      <Container size="1">
        <Flex direction="column" pb="4">
          <Heading align="center">¡Unete ahora!</Heading>
          <Text align="center"> Por favor ingresa tu información </Text>
        </Flex>
          ...
          <Card size="4" variant='surface' style={{ width: '400px' }}>
            ...
            <Box mb="5">
              <label>
                ...
                <TextFieldRoot mt="2">
                  <TextFieldInput mb="2" size="2" variant="surface" spellCheck="false" placeholder='Ingresa tu e-mail'></TextFieldInput>
                </TextFieldRoot>
              </label>
            </Box>
            <Box position="relative" mb="5">
              ...
              <label>
                ...
                <TextFieldRoot mt="2">
                  <TextFieldInput mb="2" size="2" variant="surface" spellCheck="false" placeholder='Ingresa tu contraseña'></TextFieldInput>
                </TextFieldRoot>
              </label>
            </Box>
